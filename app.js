/* CDRE Exam Simulator, Application Logic */

const ACCESS_CODE  = "CDRE9000";
const EXAM_SECONDS = 14400;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "cdre_exam_state_v1";
const SIM_Q_COUNT  = 185;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const CLUSTER_LABEL = "Case";
const DOMAIN_LABELS = {"food_and_nutrition_expertise": "Food and Nutrition Expertise", "professionalism_and_ethics": "Professionalism and Ethics", "communication_and_collaboration": "Communication and Collaboration", "management_and_leadership": "Management and Leadership", "nutrition_care": "Nutrition Care", "population_health_promotion": "Population Health Promotion", "food_provision": "Food Provision"};  // maps domain key -> human-readable label for display
